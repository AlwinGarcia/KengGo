...
INSERT INTO `admins` (`id`, `admin_code`, `name`, `email`, `password`, `role`, `status`, `last_login`, `created_at`) VALUES
(1, 'ADM-1001', 'Super Admin', 'admin@kenggo.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9iu1IJ5AZtQ.f1q5lIYFSi', 'superadmin', 'active', '2025-12-09 13:32:17', '2025-12-09 13:32:17'),
(2, 'ADM-2001', 'Ops Manager', 'manager@kenggo.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9iu1IJ5AZtQ.f1q5lIYFSi', 'manager', 'active', NULL, '2025-12-09 13:32:17'),
(3, 'ADM-3001', 'Support Staff', 'staff@kenggo.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9iu1IJ5AZtQ.f1q5lIYFSi', 'staff', 'pending', NULL, '2025-12-09 13:32:17');
...
(3, 'Shuttle 03', 'SLU-003', 'Quirino Hill to Burnham Park', '06:45:00', '07:25:00', 16, 60.00, 'active', '2025-12-11', 'Early office loop', 1),
(4, 'Shuttle 07', 'SLU-007', 'Burnham Park to Quirino Hill', '19:15:00', '19:55:00', 16, 60.00, 'active', '2025-12-11', 'Evening return loop', 2),
(5, 'Shuttle 12', 'SLU-012', 'Camp 7 to Session Road', '08:10:00', '08:55:00', 20, 70.00, 'pending', '2025-12-12', 'Needs dispatch approval', NULL),
(6, 'Shuttle 15', 'SLU-015', 'Session Road to Camp 7', '21:00:00', '21:40:00', 20, 70.00, 'inactive', '2025-12-12', 'Temporarily offline for maintenance', NULL);
...
INSERT INTO `trips` (`shuttle_number`, `driver_name`, `driver_id`, `plate_number`, `seats_available`, `from_address`, `to_address`, `trip_date`, `depart_time`, `arrive_time`, `price`, `status`, `notes`) VALUES
('Shuttle 01', 'Gideon Santos', 1, 'ABC-1234', 20, '72-74 Oxford St.', '20 Grosvenor Sq.', '2025-12-10', '07:30:00', '08:15:00', 100.00, 'active', 'Regular morning route'),
('Shuttle 23', 'Maria Cruz', 2, 'XYZ-5678', 18, 'Great Portland St.', 'Baker Street', '2025-12-10', '08:00:00', '08:45:00', 100.00, 'active', NULL),
('Shuttle 44', 'Juan Dela Cruz', 1, 'LMN-9012', 20, '103 Seymour Pl.', 'London NW1 5BR', '2025-12-10', '09:00:00', '09:45:00', 100.00, 'active', NULL),
('Shuttle 67', 'Pedro Santos', 2, 'DEF-3456', 20, '377 Durnsford Rd.', '136 Buckhold Rd.', '2025-12-10', '10:00:00', '10:45:00', 100.00, 'active', NULL);
