            ...
            <div class="trips-grid">
                <?php if (!empty($trips)): ?>
                    <?php foreach ($trips as $trip): ?>
                        <a href="index.php?page=seat-management&shuttle_id=<?= htmlspecialchars($trip['shuttle_id'] ?? '') ?>" class="trip-card">
                            <span class="trip-icon"><i class="fa-solid fa-bus"></i></span>
                            <span class="trip-route"><?= htmlspecialchars($trip['route'] ?? 'N/A') ?></span>
                            ...
                            <span class="trip-fare">Fare: ₱<?= htmlspecialchars($trip['price'] ?? '0.00') ?></span>
